...
export const NowPlaying = ({ tracks, src, title, artist, startIndex = 0 }: NowPlayingProps) => {
  ...
  return (
    ...
    >
      ...
      {isMinimized ? (
        <div
          className="h-10 w-10 rounded-full glass border border-primary/30 bg-black/40 flex items-center justify-center shadow-[0_0_30px_rgba(155,135,245,0.18)]"
          title="Now Playing"
        >
        ...
        <div
          className={
            ...
            "backdrop-blur-xl bg-black/40 overflow-hidden px-2.5 py-1.5 w-[300px]"
          }
          role="region"
